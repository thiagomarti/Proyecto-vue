<template>
<h4 class="porque"> ¿POR QUÉ TRABAJAR CON NOSOTROS?</h4>
<div> <h1 class="titulocards">OBTENDRÁS TODO LO QUE NECESITAS </h1></div>
 <br><br><br> 
 <div class="bodycards">
 <div class="grid">
  ...
  <!--tarjeta 1-->
    ...
    <div class="cards" id="tarj1">
      ...
      <p>
        Incluye la planificación, el diseño gráfico y el desarrollo de la página web.
      </p>
      <div class="shine"></div>
  ...
  <!--tarjeta 2-->
    ...
    <div class="cards" id="tarj2">
      ...
      <h4>Mantenimiento</h4>
      <p>
        Pensado para que el cliente tenga la confianza de que su página está en buenas manos. De lo contrario, podes manejarla por tu cuenta.
      </p>
      <div class="shine"></div>
      <div class="background">
        <div class="tiles">
  ...
  <!--tarjeta 3-->
    ...
    <div class="cards" id="tarj3">
      ...
      <h4>Adaptación a cualquier dispositivo</h4>
      <p>
        La página va a funcionar correctamente en todos los dispositivos y pantallas.
      </p>
      <div class="shine"></div>
      <div class="background">
        <div class="tiles">
